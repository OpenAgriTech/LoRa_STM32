...
void  BSP_MLX90614_Init( void )
{
  ...
  I2cHandle4.Init.OwnAddress1      = 0;
  I2cHandle4.Init.OwnAddress2      = 0;
  ...
  if(HAL_I2CEx_ConfigAnalogFilter(&I2cHandle4,I2C_ANALOGFILTER_ENABLE) != HAL_OK) {
		Error_Handler();
	}
	
	if (HAL_I2CEx_ConfigDigitalFilter(&I2cHandle4, 0) != HAL_OK)
  {
    Error_Handler();
  }
	
	MLX90614_Init(&I2cHandle4);
  /* Infinite loop */
}
